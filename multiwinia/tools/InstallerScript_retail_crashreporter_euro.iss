...
Source: "..\build\origin"; DestDir: "{app}"; Flags: ignoreversion onlyifdoesntexist nocompression dontverifychecksum
...
;Source: "..\build\branding.dat"; DestDir: "{app}"; Flags: ignoreversion
