...
// These functions are copied from Darwinia for use
// in the linux port of multiwinia.
...
static void fatalSignal(int signum, siginfo_t *siginfo, void *arg)
{
	...
	fprintf(stderr,
			"\n\nMultiwinia has unexpectedly encountered a fatal error.\n"
