...
//    OutputContents();
	...
	{
        AppDebugAssert( m_numSlotsFree == 0 );
    ...
    AppDebugAssert( target >= 0 );
    AppDebugAssert( target < m_arraySize);
...
{
    AppDebugAssert(_indexX >= 0 && _indexX < m_numCellsX);
    AppDebugAssert(_indexZ >= 0 && _indexZ < m_numCellsZ);
