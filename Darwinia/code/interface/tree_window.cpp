...
void TreeWindow::Create()
{
	...
	CreateValueControl( LANGUAGEPHRASE("editor_spiritdrop"),    InputField::TypeInt, &tree->m_spiritDropRate, y+=h, 1, 0, 10 );
	CreateValueControl( LANGUAGEPHRASE("editor_evil"),		    InputField::TypeInt, &tree->m_evil, y+=h, 1, 0, 1 );
}
